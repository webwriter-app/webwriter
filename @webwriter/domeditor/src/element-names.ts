...
const presentations: Record<string, ElementPresentation> = {
  ...
  ul: {name: "Bulleted List", icon: "Bulleted List"},
  ol: {name: "Numbered List", icon: "Numbered List"},
  dl: {name: "Description List", icon: "Description List"},
  li: {name: "List Item", icon: "Lists"},
  dt: {name: "Description Term", icon: "Description List"},
  dd: {name: "Description", icon: "Description List"},
  ...
  embed: {name: "Embedded Content", icon: "Website"},
  object: {name: "Embedded Content", icon: "Website"},
