...
export const appCommands: readonly AppCommand[] = [
  ...
  ...[
    ["rowAbove", "Row above", "Plus", "table-row-above"],
    ["rowBelow", "Row below", "Plus", "table-row-below"],
    ["columnLeft", "Column left", "Plus", "table-column-left"],
    ["columnRight", "Column right", "Plus", "table-column-right"],
    ["merge", "Merge cells", "Table", "table-merge-cells"],
    ["splitCells", "Split cells", "Table", "table-split-cells"],
    ["split", "Split table", "Table", "table-split"],
    ["caption", "Caption", "Text", "table-caption"],
  ].map(([id, label, icon, action]) => ({
    id: `table.${id}`,
