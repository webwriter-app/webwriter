...
export const htmlElementCapabilities = {
  ...
  button: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  datalist: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  dialog: full("dialog", "none", "Existing dialogs remain editable; incoming dialog wrappers are stripped.", {intentionallyRestricted: true}),
  ...
  fieldset: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  form: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  hgroup: full("manipulation", "none", "Existing heading groups remain editable; incoming heading-group wrappers are stripped.", {structuralEditing: true, intentionallyRestricted: true}),
  ...
  input: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  label: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  legend: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  optgroup: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  option: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  output: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  progress: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  select: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  selectedcontent: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
  ...
  textarea: none("policy", "Form authoring is unsupported; transfers preserve content as text."),
