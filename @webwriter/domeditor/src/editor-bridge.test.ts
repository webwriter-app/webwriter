...
describe("editor bridge message guards", () => {
  ...
  it("validates every optional selection-state payload", () => {
    const message = {
      ...
      detail: {
        ...
        table: {
          ...
          canSplit: false,
          hasCaption: true,
          selectedRowGroup: "thead",
          rowGroups: [{index: 1, type: "thead", rows: 1, attributes: {"data-kind": "heading"}}],
          canAddHeaderGroup: false,
          canAddFooterGroup: true,
          columnGroups: [{
            path: [0], attributes: {span: "2"}, columns: [],
          }],
    ...
    expectAllRejected(isSelectionChangeMessage, [
      ...
      {...message, detail: {...message.detail, table: {...message.detail.table, selectedRowGroup: "section"}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, rowGroups: [{index: -1, type: "tbody", rows: 1, attributes: {}}]}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, rowGroups: [{index: 0, type: "body", rows: 1, attributes: {}}]}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, columnGroups: [{path: [-1], attributes: {}, columns: []}]}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, columnGroups: [{path: [0], attributes: {}, columns: [{path: [0, 0], attributes: {span: 2}}]}]}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, cellSemantics: {role: "heading", headers: "", abbr: ""}}}},
      {...message, detail: {...message.detail, table: {...message.detail.table, cellSemantics: {role: "data", headers: [], abbr: ""}}}},
