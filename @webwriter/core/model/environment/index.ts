...
export type FileSystemAPI = {
  ...
  readFile: (
    path: string,
    options?: { encoding?: "utf8" } | string | undefined
  ) => Promise<Uint8Array | string>;
  writeFile: (
    path: string,
    data: Uint8Array | string,
    options?: { mode: number; encoding?: "utf8" } | string | undefined
  ) => Promise<void>;
...
export type WindowCloseBehavior =
  | "closeAllIfLastVisible"
  | "hideOnCloseUnlessLast"
  | "closeOthersOnReload";
...
export type Environment = {
  ...
  watch: (
    ...
    cb?: (event: {
      attrs: any;
      paths: string[];
      type: { create?: any; modify?: any; remove?: any };
    }) => void,
    options?: { recursive?: boolean; delayMs?: number }
  ) => Promise<() => void>; // wait for FileSystemObserver, shim with polling?
  getSystemFonts: () => Promise<string[]>; // wait for Local Font Access API?
  createWindow: (
    url?: string,
    options?: WindowOptions & { label?: string; hideOnClose?: boolean }
  ) => Promise<void>;
  setWindowCloseBehavior: (
    behaviors: WindowCloseBehavior[],
