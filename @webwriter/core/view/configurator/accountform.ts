...
export class PocketbaseAccountForm extends LitElement {
  ...
  get account() {
    const valueWithoutPassword = filterObject(this.value ?? {}, key => key !== "password") as any
  ...
  render() {
    return html`<form @sl-change=${this.handleFieldChange} ?inert=${this.loading} @submit=${this.handleSubmit}>
      <sl-input size=${this.size} label=${msg("Email")} type="email" name="email" value=${this.email} required ?disabled=${this.disabled}></sl-input>
      <sl-input size=${this.size} label=${msg("Password")} type="password" name="password" value=${this.password} placeholder=${this.passwordUnchanged? msg("-unchanged-"): ""} required ?disabled=${this.disabled}></sl-input>
...
export class NpmAccountForm extends LitElement {
  ...
  render() {
    return html`<form @sl-change=${this.handleFieldChange} ?inert=${this.loading} @submit=${this.handleSubmit}>
      <sl-input size=${this.size} label=${msg("URL")} type="url" name="url"></sl-input>
      <sl-input size=${this.size} label=${msg("Key")} type="text" name="key"></sl-input>
      <footer id="form-buttons">
        <slot name="footer">
          <ww-button
            outline 
